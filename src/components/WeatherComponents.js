export function conditionForecastSvg(condition) {
  if (
  ...
  if (condition.toLowerCase().includes("rain")) {
    return (
      <img
        src="https://raw.githubusercontent.com/Makin-Things/weather-icons/master/animated/rainy-3.svg"
        alt="rain"
      />
    );
  }
...
export function conditionHourlySvg(condition) {
  if (
    condition.toLowerCase().includes("sunny") ||
    condition.toLowerCase().includes("overcast")
  ) {
